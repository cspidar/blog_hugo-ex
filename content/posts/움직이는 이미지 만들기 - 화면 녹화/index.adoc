...
화면을 녹화하여 만든 움직이는 이미지로 문서의 가독성 개선

== 왜 ScreenToGif?


오픈소스. 광고, 워터마크, 분량제한 없이 사용할 수 있다.
녹화 범위 지정 가능. 고정창 마우스 따라다니기 기능 있음. 설정 항목이 다양하고 방법이 직관적. gif, avi 등 다양한 형식 제공
마우스 위치 강조나 클릭 효과있음.
...
해상도: 720P, 시간: 20초 기준 6 MB 정로 용량의 결과물을 얻을 수 있다.
